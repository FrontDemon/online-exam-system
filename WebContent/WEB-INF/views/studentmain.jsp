	...
	<div class="headbar">
			<div class="box">
				...
				<form action="searchpaper" method="post">
					<div class="fl search" style="z-index:9999;">
        		...
        		<div class="fr islogin">
        			...
        			<a href="loginout" id="loginout" class="name" style="margin-left:25px;" onclick="alert('注销成功!');">注销</a>
        		</div>
		...
		<div class="undershutter">
			<input class="btn-exam" type="button" value="立即考试" onclick="window.location.href = 'subject';"/>
		</div>
	</body>
</html>