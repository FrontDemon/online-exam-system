		                ...
		                <form name="myform" action="login_to_main" method="post" id="loginForm">
		                    <ul>
		                        <li style="margin-top:0px;">
		                            <input type="text" placeholder="用户名/UID" name="userName" placeholder="用户名/UID" id="userName" class="username">
		                        </li>
		                        <li>
		                            <input type="password" placeholder="密码/PSW" name="passWord" placeholder="密码/PSW" id="passWord" class="password">
		                        </li>
		                        <li>
		                            <span style="display:none">
		                            	<input type="text" onfocus="this.value=(this.value=='验证码')?'':this.value" onblur="this.value=(this.value=='')?'验证码':this.value" name="VerifyCode" value="验证码" id="TxtVerifyCode" class="password" style="width:60px"/> 
