...
<script>
	$(function(){
		var searchpaperName = '${searchpaperName}';
		$.ajax({
			async:false,
			url:"searchpaperaction",
			data:{"searchpaperName":searchpaperName},
...
<body>
	<div class="headbar">
		...
		<div style="margin:50px auto;width:70%;padding:10px 0 30px 0;">
			...
			<div style="line-height:25px;float:left;font-size:25px;margin-left:25px;">考试试卷</div>
		</div>
